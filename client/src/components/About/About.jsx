    ...
    return <div className='about-background-container'>
                <div className='about-main-container'>
                    ...
                    <div className='about-info'>
                        <p>FoodsterR was developed during the bootcamp at Henry. The goal was to build an App using React JS, Redux, Node JS, Express JS, Sequelize and PostgreSQL. In addition to Spoonacular's Food Api. Connect the concepts learned in the course. Learn best practices. Learn and practice GIT workflow. Use and practice some testing.</p>
